    ...
    <div className="min-h-screen font-sans text-gray-800">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center">
        <div className="absolute inset-0 overflow-hidden">
          <img 
            src={`${import.meta.env.BASE_URL}assets/background-pic-1.jpeg`} 
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 grid-rows-2 gap-8 items-stretch">
            ...
            <div className="flex items-center justify-center h-80 md:h-full bg-gray-100 rounded-lg overflow-hidden border border-gray-200">
              <img 
                src={`${import.meta.env.BASE_URL}assets/henrique-photo-office-2.png`} 
                alt="Henrique Kratka" 
                className="object-cover object-top w-full h-full max-h-80 md:max-h-full rounded-lg"
                style={{ aspectRatio: '1/1', minWidth: '200px', minHeight: '200px', background: '#f3f4f6' }}
              />
            </div>
            {/* Q3: Bottom Left - Lawyer photo */}
            <div className="flex items-center justify-center">
              <img 
                src={`${import.meta.env.BASE_URL}assets/servico-photo.jpeg`} 
                alt="Serviço em andamento" 
                className="rounded-lg shadow-lg object-cover w-full h-80 md:h-full filter grayscale"
              />
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <div className="h-96 md:h-full rounded-lg overflow-hidden shadow-md">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3737.661964243527!2d-49.24739362485744!3d-16.67893468412013!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x935ef1b2e2e2e2e3%3A0x1234567890abcdef!2s5%C2%AA%20Avenida%2C%20182%20-%20Leste%20Universit%C3%A1rio%2C%20Goi%C3%A2nia%20-%20GO%2C%2074605-040%2C%20Brazil!5e0!3m2!1sen!2sbr!4v1710000000000!5m2!1sen!2sbr" 
                  width="100%" 
                  height="100%" 
                  frameBorder="0" 
                  style={{ border: 0 }} 
      ...
      <Footer />
      <WhatsAppButton 
        phoneNumber="5562999940583" // Updated WhatsApp number
