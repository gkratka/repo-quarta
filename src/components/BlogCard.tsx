  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden h-full flex flex-col hover:shadow-lg transition-shadow duration-300">
      <div className="h-48 overflow-hidden">
        <img 
          src={post.image.startsWith('http') ? post.image : `${import.meta.env.BASE_URL}${post.image}`} 
          alt={post.title} 
      ...
      <div className="p-6 flex-grow flex flex-col">
        ...
        {post.link ? (
          <a
            ...
            className="text-xl font-serif font-semibold text-gray-800 mb-2 hover:text-primary transition-colors block"
          >
            {post.title}
          </a>
        ) : (
