        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <ContactItem icon={<MapPin size={18} />} text="5ª Avenida, 182 - quadra 102 lote 13, Leste Universitário, Goiânia - GO, 74605-040" />
              <ContactItem icon={<Phone size={18} />} text="62 999940583" />
              <ContactItem icon={<Mail size={18} />} text="hbconsultoriaambiental@gmail.com" />
